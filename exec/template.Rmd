...
```{r pairnames, bootstrap.show.code=F, eval=F}
...
Our final goal is to get an initial sense of how much value this gene signature would provide in a clinical trial setting. We focus on this setting because we 
...
This report was built using the [sig2trial](https://github.com/prpatil/sig2trial/) R package.
